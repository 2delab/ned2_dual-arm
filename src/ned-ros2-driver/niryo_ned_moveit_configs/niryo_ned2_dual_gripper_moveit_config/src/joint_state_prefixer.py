#!/usr/bin/env python3
"""
Joint State Prefixer & Trajectory Proxy for Dual-Arm MoveIt2
PRODUCTION VERSION - Threading with proper executor isolation
"""
    ...
    def _publish_combined_states(self):
        ...
        with self.state_lock:
            ...
            for ns in sorted(self.joint_states.keys()):
                ...
                # Add MORS (MoveIt-on-Rails) mounting joints as fixed at position 0.0
                # These are passive attachment points, not actively controlled
